...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        <!-- Blog Form Start -->
                        <form action="/admin/umkm/edit/{{$data->id}}" method="POST" enctype="multipart/form-data" onsubmit="submitQuillContent()">
                        @csrf
                          <!-- Blog Title -->
                          <div class="mb-3">
                            <label for="blogTitle" class="form-label">Judul</label>
                            <input type="text" class="form-control" id="blogTitle" name="title" value="{{$data->judul}}" required>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="mt-3">
                              <div class="thumbnail-preview" id="thumbnailPreview">
                                <img src="/storage/img/thumbnail/{{$data->thumbnail}}" alt="" srcset="">
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="mt-3 multi-image-preview" id="multiImagePreview">
                              @foreach ($data->array_images as $item)
                              <img src="/storage/img/UMKM/{{$item}}" alt="" srcset="">
                              @endforeach
                            </div>
                          </div>

                          <!-- Submit Button -->
                          <button type="submit" class="btn btn-primary">Perbarui Data UMKM</button>
                        </form>
                        <!-- Blog Form End -->
                      </div>
                    </div>
    ...
    <script>
        ...
        var deskripsi = @json($data->konten ?? null);
