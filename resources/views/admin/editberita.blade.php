            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="card shadow mb-4">
                      ...
                      <div class="card-body">
                        <!-- Blog Form Start -->
                        <form action="/admin/berita/edit/{{$data->id}}" method="POST" enctype="multipart/form-data" onsubmit="submitQuillContent()">
                        @csrf
                          <!-- Blog Title -->
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <div class="mt-3 multi-image-preview" id="multiImagePreview">
                                @if ($data->array_images)
                                    @foreach ($data->array_images as $item)
                              <img src="/storage/img/dokumentasi/{{$item}}" alt="" srcset="">
                              @endforeach
                                @endif
