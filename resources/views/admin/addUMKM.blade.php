                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="card shadow mb-4">
                      <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Buat Informasi UMKM</h6>
                      </div>
                      <div class="card-body">
                        <!-- Blog Form Start -->
                        <form action="/admin/umkm/upload" method="POST" enctype="multipart/form-data" onsubmit="submitQuillContent()">
                        @csrf
                          <!-- Blog Title -->
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="multiImageUpload" name="images[]" multiple accept="image/*" onchange="showMultiImagePreview(event)" required>
                          ...
                          <!-- Submit Button -->
                          <button type="submit" class="btn btn-primary">Buat Informasi UMKM</button>
                        </form>
                        <!-- Blog Form End -->
                      </div>
                    </div>
