            ...
            <div id="newsImageCarousel" class="carousel slide mb-4" data-bs-ride="carousel">
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        <img src="{{ asset('/storage/img/dokumentasi/' . $image) }}" class="d-block w-100" alt="News Image" style="height: 450px; object-fit: cover;">
                    </div>
                    @endforeach
                </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <a href="/berita/{{$recent->id}}" class="text-decoration-none">
